namespace TreasureIslandRace.Forms
{
    partial class SquareEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // lblSquareIndex
            // 
            lblSquareIndex.Location = new Point(5, 19);
            lblSquareIndex.Name = "lblSquareIndex";
            lblSquareIndex.RightToLeft = RightToLeft.No;
            lblSquareIndex.Size = new Size(260, 20);
            lblSquareIndex.TabIndex = 0;
            lblSquareIndex.Text = "משבצת מספר:";
            lblSquareIndex.TextAlign = ContentAlignment.TopRight;
            // 
            // label1
            // 
            ...
            cmbSquareType.Location = new Point(23, 56);
            ...
            // numParam
            // 
            numParam.Location = new Point(123, 87);
